		...
		foreach ($rows as $row) {
			?>
				<tr>
			        ...
			        <td><a href="#" class="btn btn-success btn-sm">Active</a></td>
			        <td>
			        	<a href="#" did="<?php echo $row['pid']; ?>" class="btn btn-danger btn-sm del_products">Delete</a>
			        	<a href="#" eid="<?php echo $row['pid']; ?>" data-toggle="modal" data-target="#form_products" class="btn btn-info btn-sm edit_products">Edit</a>
			        </td>
			      </tr>
			<?php
			$n++;
...
if (isset($_POST["update_products"])) {
	$m = new Manage();
	$id = $_POST["pid"];
	$name = $_POST["update_products"];
	$cat = $_POST["select_cat"];
	$brand = $_POST["select_brand"];
	$price = $_POST["products_price"];
	$qty = $_POST["products_stock"];
	$date = $_POST["added_date"];
	$result = $m->update_record("products",["pid"=>$id],["cid"=>$cat,"bid"=>$brand,"products_name"=>$name,"products_price"=>$price,"products_stock"=>$qty,"added_date"=>$date]);
	echo $result;
}
	...
	<tr>
		    ...
		    <td>
		        <select name="pid[]" class="form-control form-control-sm pid" required>
		            ...
		            <?php 
		            	foreach ($rows as $row) {
		            		?><option value="<?php echo $row['pid']; ?>"><?php echo $row["products_name"]; ?></option><?php
		            	}
		            ?>
		        </select>
		    </td>
