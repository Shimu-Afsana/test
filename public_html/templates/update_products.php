        ...
        <form id="update_product_form" onsubmit="return false">
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="text" class="form-control" name="update_products" id="update_products" placeholder="Enter Product Name" required>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="products_price" name="products_price" placeholder="Enter Price of Product" required/>
          </div>
          <div class="form-group">
            <label>Quantity</label>
            <input type="text" class="form-control" id="products_stock" name="products_stock" placeholder="Enter Quantity" required/>
          </div>
